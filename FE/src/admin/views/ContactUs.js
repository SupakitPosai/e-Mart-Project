...
export default class ContactUs extends Component {
    ...
    componentWillMount() {
        axios.get(ROOT_API + "/api/getOrderStatus/rgtg3f2323fsfwffg22gsaa").then(response => {
    ...
    sub() {
        axios.put(ROOT_API + "/api/getOrderStatus/rgtg3f2323fsfwffg22gsaa", this.state).then(response => {
