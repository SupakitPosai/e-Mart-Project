...
export default class Policy extends Component {
    ...
    componentWillMount() {
        axios.get(ROOT_API + "/api/getOrderStatus/ewcew2c21c1wc1wc").then(response => {
    ...
    sub() {
        axios.put(ROOT_API + "/api/getOrderStatus/ewcew2c21c1wc1wc", this.state).then(response => {
