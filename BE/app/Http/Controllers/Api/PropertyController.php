...
class PropertyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $Property = Property::where('id_product','=', $request->id_product)
        ->where('id_type_property','=', $request->id_type_property)
        ->get();
        return $Property;
    }
    ...
    public function store(Request $request)
    {
        ...
        $Property->id_property=$id_member;
        $Property->name_property = $request->get('name_property');
        $Property->id_product = $request->get('id_product');
        $Property->id_type_property = $request->get('id_type_property');

        if($request->get('file')!=''){
            $img = str_replace('data:image/jpeg;base64,','',$request->get('file'));
            $img = str_replace(' ','+',$img);
            echo file_put_contents(storage_path()."/img_property/property-".$date.".jpg", base64_decode($img));
            
            $Property->img_property = "/img_property/property-".$date.".jpg";
        }
